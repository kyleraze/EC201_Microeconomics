...
.more-left[
```{r market_demand, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
...
.more-left[
```{r market_supply, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
.more-left[
```{r equilibrium, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
...
.more-left[
```{r equilibrium2, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
market + 
...
.more-left[
```{r shortage1, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
...
.more-left[
```{r shortage2, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
market + geom_hline(yintercept = 3, linetype  = "dashed", color = met_slate, size = 1) +
...
.more-left[
```{r surplus1, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
...
.more-left[
```{r surplus2, echo = FALSE, fig.height = 5.25, fig.width = 5.25, dev = "svg"}
market + geom_hline(yintercept = 7, linetype  = "dashed", color = met_slate, size = 1) +
...
.more-left[
```{r mv, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
...
.more-left[
```{r mv1, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r mv1b, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r mv2, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r mv2b, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r mv3, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r mv3b, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r cs, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "MV") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r ind_demand1, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
  geom_step(color = red_pink, size = 1) +
  labs(x = "q", y = "P") +
  scale_x_continuous(limits = c(0, 9.5), expand = c(0, 0), breaks = seq(0, 9, 1)) +
...
.more-left[
```{r ind_demand2, echo = FALSE, fig.height = 5.65, fig.width = 5.65, dev = "svg"}
ggplot(data = step_demand, mapping = aes(x = x, y = mv)) +
...
```{r p_increase, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
.center[**Increase in Price .mono[->] Decrease in q.sub[D]**]
```{r p_increase2, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
```{r p_decrease, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
.center[**Decrease in Price .mono[->] Increase in q.sub[D]**]
```{r p_decrease2, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
```{r demand_increase, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
.center[**An Increase in Demand**]
```{r demand_increase2, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
```{r demand_decrease, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
...
.center[**A Decrease in Demand**]
```{r demand_decrease2, echo = FALSE, fig.height = 5.75, fig.width = 5.75, dev = "svg"}
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  scale_x_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  scale_y_continuous(limits = c(0, 10.5), expand = c(0, 0), breaks = seq(0, 10, 1)) +
  theme_market +
